  ...
  <div class="col-md-5 col-xs-9">
    ...
    <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
        ...
        //echo $sql;
                                    ...
                                    if ($result->num_rows > 0) {
                                        while($row = $result->fetch_assoc()) {
                                             ?>
        <img src="admin/uploads/layout_plan/<?php echo $row['image']; ?>" class="img-responsive">
            ...
            <div id="main">
              <div class="row">
               <ul class="gallery clearfix">
                <li class="col-md-3">
                  <div class="gal-each"><a href="images/layout/1.jpg" rel="prettyPhoto[gallery2]" title="">
                    <img src="images/layout/1.jpg" alt="" class="img-responsive"/></a></div>
                  </li>
                  <li class="col-md-3">
                    <div class="gal-each"><a href="images/layout/2.jpg" rel="prettyPhoto[gallery2]" title="">
                      <img src="images/layout/2.jpg" alt="" class="img-responsive" /></a></div>
                    </li>
                    <li class="col-md-3">
                      <div class="gal-each"><a href="images/layout/3.jpg" rel="prettyPhoto[gallery2]" title="">
                        <img src="images/layout/3.jpg" alt="" class="img-responsive" /></a></div>
                      </li>
                      <li class="col-md-3">
                        <div class="gal-each"><a href="images/layout/4.jpg" rel="prettyPhoto[gallery2]" title="">
                          <img src="images/layout/4.jpg" alt="" class="img-responsive" /></a></div>
                        </li>                             
                      </ul>
                    </div>
                  </div>
            ...
            <div class="amenity clearfix">
             <div class="amenity-each">
              ...
              <ul>
                ...
                <li <?php if (strpos($amenities, 'Bathrooms') == false){ ?> class="un" <?php } ?> >
                 <div class="amenityimg"><img src="images/Amenities/Bathrooms.png"></div>
                 <div class="amen">Bathrooms <?php echo $number_of_bathroom; ?></div>
               </li>
   ...
   <div class="amenity-each">
    <ul>
     ...
     <li  <?php if (strpos($amenities, 'Bacheloirs') == false){ ?> class="un" <?php } ?> >
       <div class="amenityimg"><img src="images/Amenities/Bacheloirs.png"></div>
       <div class="amen">Bacheloirs</div>
     </li>
   </ul>
 </div>
</div>		  
...
<div class="container-fluid">
  <div class="container newsletter">
    ...
    <div class="newsletter-form">
      ...
      <input type="submit" class="shoot" value="Shoot" name="Shoot"/>
      </form>
<script>
