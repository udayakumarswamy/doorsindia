...
<html lang="en">
  ...
  <div class="row">
	 <h2 class="col-md-12"><i class="glyphicon glyphicon-plus"></i> Add Deals</h2>  	 
	</div>
  <div class="row">
  <div class="col-md-7">
  <form role="form" id="addprop" action="addnewdeal.php" method="post" enctype="multipart/form-data">
	...
	<div class="form-group">
      ...
      <div class="col-md-9">
        <select name="property_type[]" id="property_type"  multiple="multiple">
   ...
   <div class="form-group">
      <label for="email" class="col-md-3 no-pad">Actual Price:</label>
      <div class="col-md-9">
    ...
    <div class="form-group">
      <label for="haslo" class="col-md-3 no-pad">Discounted Price:</label>
      <div class="col-md-9">
    ...
    <div class="form-group">
      <label for="haslo" class="col-md-3 no-pad">Number of Units Sold:</label>
      <div class="col-md-9">
        <input type="text" class="form-control" name="number_of_units_sold" id="number_of_units_sold" placeholder="Number of Units Sold">
      </div>
    </div>

    <div class="form-group">
      <label for="haslo" class="col-md-3 no-pad">Number of units available:</label>
      <div class="col-md-9">
        <input type="text" class="form-control" name="number_of_units_sold" id="number_of_units_available" placeholder="Number of units available">
      </div>
    </div>
    <div class="form-group">
