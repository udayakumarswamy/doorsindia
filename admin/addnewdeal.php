...
$myday=date("M d ,Y");
echo"<br>";
$sql = "INSERT INTO door_deal_details (name, email, mobile, person_name, about_agents, property_name, description, transaction_type, property_type, actual_price,discounted_price,number_of_units_sold,number_of_units_available, number_of_bedrooms, number_of_bathroom, property_size, overview, city, location_of_the_property, google_location, video, brochure, amenities,date_of_creat, type, status) VALUES ('$name','$email',$mobile,'$person_name','$about_agents','$property_name','$description','$transaction_type','$property_type','$actual_price','$discounted_price','$number_of_units_sold','$number_of_units_available','$number_of_bedrooms_res','$number_of_bathroom_res','$property_size','$overview','$city','$location_of_the_property','$google_location','$video','$brochure','$amenities_all_res','$myday','d',1)";
//echo $sql;
