...
<head>
  ...
  <!-- WARNING: Respond.js doesn't work if you view the page via file:// -->
    ...
    $id=$_GET['id'];
    $sql = "SELECT * FROM door_deal_details WHERE id=".$id;
...
//echo $sql;
    ...
    <div class="container forms">
      <div class="row">
        <h2 class="col-md-12"><i class="glyphicon glyphicon-plus"></i> Update Deal</h2>  	 
      </div>
      <div class="row">
        <div class="col-md-7">
          <form role="form" id="addprop" action="updatedeal.php" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
              <label for="imie" class="col-md-3 no-pad">Deal Name:</label>
              <div class="col-md-9">
                <?php echo "ID:".$_GET['id']; ?>
            ...
            <div class="form-group">
              <label for="imie" class="col-md-3 no-pad">Deal Overview:</label>
              <div class="col-md-9">
            ...
            <div class="form-group">
              <label for="imie" class="col-md-3 no-pad">Deal description:</label>
              <div class="col-md-9">
            ...
            <div class="form-group">
              <label for="miejscowosc" class="col-md-3 no-pad">Deal Type:</label>
              <div class="col-md-9">
               <select name="property_type" id="property_type" class="form-control" multiple="multiple">
          ...
          <div class="form-group">
            <label for="haslo" class="col-md-3 no-pad">Deal Size:</label>
            <div class="col-md-9">
         ...
         <div class="form-group">
          <label for="propimage" class="col-md-3 no-pad">Deal Images:</label>
          <div class="col-md-9">
            <?php
...
<div class="form-group">
  ...
  <div class="col-sm-9">
    <select id="restrictions" name="restrictions[]" multiple="multiple">
      ...
      <option <?php if (strpos($amenities, 'Vegetarians only') !== false){ echo "selected";} ?> >Vegetarians only</option>
...
<div class="form-group">
  ...
  <div class="col-sm-9">
    <select id="amenities" name="amenities[]" multiple="multiple">
      ...
      <option <?php if (strpos($amenities, 'Air Conditioned') !== false){ echo "selected";} ?> >Air Conditioned</option>
